...
Private frame_no As Long = 0
Private next_delta_frame As Long = 0
Public g_speedRunnerControlFile As Integer = 0
Public g_speedRunnerGameplayLog As Integer = 0
