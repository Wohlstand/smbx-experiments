...
'LEVEL MUSIC
    ...
    AddMusic "music17", App.Path & "\music\smw-ghosthouse.spc|0;g=2.0", App.Path & "\music\smw-ghosthouse.mp3"
    ...
    AddMusic "music21", App.Path & "\music\mariorpg-bowser.spc|0;g=2.0", App.Path & "\music\mariorpg-bowser.mp3"
    ...
    AddMusic "music31", App.Path & "\music\mariorpg-seasidetown.spc|0;g=2.0", App.Path & "\music\mariorpg-seasidetown.mp3"
    ' mciSendString "open " & Chr(34) & App.path & "\music\mariorpg-tadpolepond.mp3" & Chr(34) & " alias music32", 0, 0, 0
    AddMusic "music32", App.Path & "\music\mariorpg-tadpolepond.spc|0;g=2.0", App.Path & "\music\mariorpg-tadpolepond.mp3"
    ' mciSendString "open " & Chr(34) & App.path & "\music\mariorpg-nimbusland.mp3" & Chr(34) & " alias music33", 0, 0, 0
    AddMusic "music33", App.Path & "\music\mariorpg-nimbusland.spc|0;g=2.0", App.Path & "\music\mariorpg-nimbusland.mp3"
    ' mciSendString "open " & Chr(34) & App.path & "\music\mariorpg-rosetown.mp3" & Chr(34) & " alias music34", 0, 0, 0
    AddMusic "music34", App.Path & "\music\mariorpg-rosetown.spc|0;g=2.0", App.Path & "\music\mariorpg-rosetown.mp3"
